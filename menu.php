    ...
    <div id="div1" class="container">
        ...
        <?php if($resultado->num_rows>0)?> 
            ...
            <?php
                    ...
                    <label class="biemenu" style="font-size: 35px; font-weight: 800;">Bienvenido <?php echo $_SESSION['nusuario'] ?></</label><br><br>
                    ...
                    <br><br>
                    <input style="width: 30%;" class="btn btn-danger" type="button" onclick="location.href ='index.php'" value="salir">
